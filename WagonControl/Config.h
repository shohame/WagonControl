...
#define CONTINUOUSLY_GO_FORWARD_SPEED 300 // upto 1000
...
#define SMALL_JOYSTICK_LEFT_PIN A0
#define SMALL_JOYSTICK_RIGHT_PIN A1
#define SMALL_JOYSTICK_PUSH_PIN 13
...
#define BT_TX_PIN 5 // this pin is connected to RX on BT module
